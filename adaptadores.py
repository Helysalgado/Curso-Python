...
for lines in file:
  ...
  # 4 se guardan las secuencias sin adaptadores (*para que concordaran 
  # los outputs los adaptadores son de 10 bp, no 14)
  seq_no_adapt.append(lines[9:])

  # 5. se imprimen en pantalla la longitud de cada secuencia
  print(len(lines[9:]))

# 6. Se guardan las secuencias sin adaptadores en un archivo
with open("without_adapter_sequences.txt", "w") as newfile:
